...
$(document).ready(function () {
    ...
    $('#add').click(function () {
        ...
        if (isAllValid) {
            ...
            $('#add', $newRow).addClass('remove').val('remove').removeClass('btn btn-success').addClass('btn btn-danger');
    ...
    $('#submit').click(function () {
        ...
        if (isAllValid) {
            ...
            $.ajax({
                ...
                url: '/RequestOrder/Save',
                data: JSON.stringify(data),
                contentType: 'application/json',
                success: function (data) {
                    if (data.status) {
                        alert('Requested Item Successfully Saved ! ' + response.responseText);
                        //Clear the form
                        list = [];
                ...
                error: function (response) {
                    //console.log(error);
                    alert('Error Input ! ' + response.responseText);
                    $('#submit').text('Save');
                }
            });
        }
...
$(function () {
    ...
    $('#sEmployeeID').autocomplete({
        source: '/RequestHeader/getRequester',
        select: function (event, ui) {
            event.preventDefault();
            $('#sEmployeeID').val(ui.item.label);
...
///////// JS Function for Dynamic autoSum    /////////
...
*/
////////// End JS Function for Dynamic autoSum  /////////